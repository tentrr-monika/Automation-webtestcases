...
/**
 * Created by monikapathak on 1/17/17.
 */
...
public class Campkeeperquiz extends Locomotive {
    ...
    public void testCampkeeperquiz() throws Exception {
        ...
        //wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".btn.btn-default.btn-onboarding-submit")));
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath(".//*[@id='onboarding-email']")).sendKeys("qaa30.tentrr@mailinator.com");
