...
// Switch to new window opened
        ...
        List<WebElement> selectElements= driver.findElements(By.xpath("//label[contains(text(), 'I agree to')]"));
        if (!(driver.findElement(By.xpath("//label[contains(text(), 'I agree to')]")).isSelected()))
        {
            for (int i = 0; i < 1 ; i++)
            {
                try {
